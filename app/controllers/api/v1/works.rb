    ...
    class Works < Grape::API
      ...
      resource :works do
        ...
        params do
          ...
          optional :min_year, type: String, desc: "Mininum year of date range of work's creation"
          optional :max_year, type: String, desc: "Maximum year of date range of work's creation"
          optional :place, type: String, desc: "Approximate location of creation"
          optional :latitude, type: String, desc: "Latitude of location of creation"
          optional :longitude, type: String, desc: "Longitude of location of creation"
